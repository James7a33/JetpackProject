...
import com.frame.net.util.CharacterHandler.Companion.jsonFormat
import com.frame.net.util.DefaultFormatPrinter
import com.frame.net.util.FormatPrinter
import com.frame.net.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.frame.net.util.ZipHelper.Companion.decompressForGzip
import com.frame.net.util.ZipHelper.Companion.decompressToStringForZlib
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (logResponse) {
            ...
            val header: String = if (originalResponse.networkResponse == null) {
                ...
                // 手动提取并打印敏感头字段
                val headers = originalResponse.networkResponse!!.request.headers
