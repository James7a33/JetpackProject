 ...
 */
fun BaseViewModel.rxHttpRequest(requestDslClass: com.frame.f_base.base.req.HttpRequestDsl.() -> Unit): Job? {
 ...
 */
fun <T> BaseViewModel.rxHttpRequestCallBack(requestDslClass: com.frame.f_base.base.req.HttpRequestCallBackDsl<T>.() -> Unit): MutableLiveData<T>? {
